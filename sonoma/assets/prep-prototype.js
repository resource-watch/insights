  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el0, el1);
        var el1 = dom.createComment(" {{else if (eq currentPath \"data\")}}\n  {{partial 'partials/header-data'}}\n{{else}}\n  {{partial 'partials/header'}}\n{{/if}} -}} ");
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n\n\n");
        dom.appendChild(el0, el1);
        var el1 = dom.createComment("");
        ...
        var el1 = dom.createComment("");
        dom.appendChild(el0, el1);
        var el1 = dom.createComment(" {{else if (noteq currentPath \"data\")}}\n  {{partial 'partials/footer'}}\n{{/if}} -}} ");
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n\n");
        dom.appendChild(el0, el1);
...
if (!runningTests) {
  equireray("prep-prototype/app")["default"].create({"name":"prep-prototype","version":"0.0.0+bb847361"});
}
